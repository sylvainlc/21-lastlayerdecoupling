...
\begin{figure*}[htpb]
	...
	\caption{Prediction of humidity (top) and CO2 (bottom) given observation ($t<96$) and without ($t>96$). Since re sampling of particles is not longer available, the uncertainty grows. As a comparison, we plotted the predictions of the pretrained network, before implementing SMC methods.}%
