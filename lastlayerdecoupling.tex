...
\begin{figure*}[htpb]
	\centering
	\includegraphics[width=.8\linewidth]{boxplot_comparison.png}
...
\begin{table}[htpb]
	...
	\begin{tabular}{lll}
		...
		MC Dropout $p_{\texttt{drop}}=0.15$ & $0.23 \pm 0.016$  & $0.195 \pm 0.0011$ \\
		MC Dropout $p_{\texttt{drop}}=0.3$  & $0.28 \pm 0.0230$ & $0.258 \pm 0.0043$ \\
		\bottomrule
	\end{tabular}
\end{table}
