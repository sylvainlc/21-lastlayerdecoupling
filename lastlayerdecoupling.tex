...
\begin{table}[htpb]
	\centering
	\caption{Comparison of PI metrics  of our model and the LSTM Dropout. Mean values of the estimator on the validation set are displayed, along with their variance.}
