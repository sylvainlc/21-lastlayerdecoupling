...
\textcolor{red}{Donner taille des inputs, nombre de couches, taille des échantillons, donner la fonction de co\^ut $\mathcal{L}_{\mathrm{inp}}$ (MSE j'imagine), nombre de particules... etc. il ne faut pas qu'il reste de myst\`eres.}
...
\textcolor{red}{On peut ajouter un tableau sur un paquet d'échantillons de test (100 par exemple) en comptant le nombre de fois où la vérité tombe dans l'intervalle : moyenne et variance de cette quantité?}
