...
\address{
	...
	$^{\dagger}$ Accenta, Boulogne-Billancourt.
}
%
% For example:
% ------------
...
\subsection{Data}
\label{sub:data}
We evaluated our model against two time series dataset, both private and public, described in the following paragraphs.
...
\textbf{Humidity.}
The air quality database contains hourly indoor humidity levels, that we aim to forecast based on weather conditions, namely outdoor humidity and temperature.
The dataset is split into training (2020) and validation (2021) sets.
