...
We propose for instance to remove the pointed confusing paragraph and to add  %"These recurrent architectures are able to approximate complex nonlinear time series, but suffer from overconfidence when evaluated outside of their training observations. Bayesian statistics aim at mitigating this drawback by providing uncertainty estimation" 
 the following statement: "The use of latent data models and Bayesian simulation procedures allows to approximate the distributions of future observations given past records and to provide uncertainty estimation, which is a challenging and active area of research in deep learning".% an to provides aim at mitigating this drawback by providing uncertainty estimationto use and Monte Carlo 
%"These recurrent architectures are able to approximate complex nonlinear time series, but are prone to making overly confident errors. Bayesian statistics aim at mitigating this drawback by providing uncertainty estimation".
